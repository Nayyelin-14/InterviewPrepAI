...
const AiResponsePreview = ({ content }) => {
  ...
  //    content is Markdown text (from AI)
  //  ReactMarkdown parses it
  // children is provided by the Markdown parser
  //  You style the parsed components yourself
  //  remarkGfm adds extra Markdown features
  return (
      ...
      <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
        <ReactMarkDown
          ...
          components={{
            ...
            p({ children }) {
              return <p className="mb-4 leading-5 font-medium">{children}</p>;
            },
            strong({ children }) {
...
const CodeBlock = ({ code, language }) => {
  ...
  return (
    <div className="relative my-6 rounde-lg  overflow-hidden bg-gray-100 border border-gray-400 ">
